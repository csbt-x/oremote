...
export abstract class AttributePicker extends OrMwcDialog {
    ...
    protected abstract setDialogContent(): void;

    protected abstract setDialogActions(): void;
     ...
     */
    protected async getAttributesTemplate(attributes?: Attribute<any>[], descriptors?: AttributeDescriptor[], selectedNames?: string[], multi = false, onSelect?: (attrNames: string[]) => void): Promise<TemplateResult> {
